...
//------------------
const Bmw_m3_2021 = ({ color }) => {
  const gltf = useGLTF("/3d/car/bmw_m3_2021/scene.gltf");
  useEffect(() => {
    gltf.scene.scale.set(1, 1, 1);
    gltf.scene.position.set(70,-1,50)
